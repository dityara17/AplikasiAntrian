...
@section('content')
    <div class="page-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Ubah Berita</h1>
            ...
            <div class="card">
                <div class="well bs-component">
                    <fieldset>
                        ...
                        <form class="form-horizontal" action="{!! url('admin/post/edit/'.$data->id_post.'') !!}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <img style="max-width: 100%" src="{!! asset('images/berita/'.$data->images.'') !!}" alt="">
                                    <br> <br>
