...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <h3 class="card-title">Berita Terbaru <a href="{!! url('admin/post/insert') !!}"
                        ...
                        @foreach($post as $key => $value)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{!! url('admin/post/edit/'.$value->id_post.'') !!}" class="btn btn-success" title="Ubah"><i
                                ...
                                <script>
                                    $(document).on('click', '.button', function (e) {
                                        ...
                                        swal({
                                            ...
                                            if (isConfirm) {
                                                location="{{url('admin/post/delete/'.$value->id_post.'')}}";
