...
<html lang="en">
    ...
    <div class="container">
    	<form>
			...
			<br/>
			<label for="exampleInputEmail1">Insert DB 100</label>
        	<div class="reset_statuss">
			</div> 
    	...
    	<br/>
      	<footer class="footer">
        <p>&copy; Nama Instansi <?php echo date("Y");?></p>
      	</footer>
    </div>
  	</body>
	...
	$("document").ready(function()
	{
		...
		$(".insert").click(function(){
			$.post( "../apps/admin_inserts.php", function( data ) {
			var alert = '<div class="alert alert-info alert-dismissible reset_status" role="alert">'+data['status']+'</div>';
			$(".reset_statuss").html(alert);
			},"json");
		});
